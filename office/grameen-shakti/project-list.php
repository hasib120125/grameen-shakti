...
<!-- Mirrored from eyecix.com/html/ecoenvironment/project-list.html by HTTrack Website Copier/3.x [XR&CO'2014], Fri, 06 Apr 2018 16:17:45 GMT -->
<head>
    <meta charset="utf-8">
    <meta http-equiv="X-UA-Compatible" content="IE=edge">
    <meta name="viewport" content="width=device-width, initial-scale=1">
    <!-- The above 3 meta tags *must* come first in the head; any other head content must come *after* these tags -->
    <title>EcoEnvironment Project List</title>
  ...
  <body>
    ...
    <div class="environment-main-wrapper">
		...
		<header id="environment-header" class="environment-header-one">
            <div class="container">
                <div class="row">
                    <div class="col-md-3"> <a href="index-2.html" class="environment-logo"><img src="images/logo.png" alt=""></a> </div>
                    <div class="col-md-9">
                            ...
                            <nav class="navbar navbar-default">
                                ...
                                <div class="collapse navbar-collapse" id="navbar-collapse-1">
                                    <ul class="nav navbar-nav">
                                        ...
                                        <li class="active"><a href="project-grid.html">Projects</a>
                                            <ul class="environment-dropdown-menu">
			...
			<div class="environment-main-section">
				<div class="container">
					<div class="row">
						...
						<div class="col-md-9">
                            <div class="environment-project environment-project-list">
                                <ul class="row">
                                    <li class="col-md-12">
                                        <div class="environment-project-list-wrap">
                                            <figure><a href="project-detail.html"><img src="extra-images/project-list-img1.jpg" alt=""><i class=" icon-search4"></i></a></figure>
                                            <section>
                                                <h5><a href="project-detail.html">Save The Elephent Of Africa</a></h5>
                                                <span>Animal Donate</span>
                                                <p>Lorem ipsum dolor sit amet, consectetur adipisci elit. Vestibulu rabitur dignissim luctus nisi id euismod. Don tincidunt diamn tempus donec imperdiet.</p>
                                                <a href="project-detail.html" class="environment-readmore-btn">Read More</a>
                                            </section>
                                        </div>
                                    </li>
                                    <li class="col-md-12">
                                        <div class="environment-project-list-wrap">
                                            <figure><a href="project-detail.html"><img src="extra-images/project-list-img2.jpg" alt=""><i class=" icon-search4"></i></a></figure>
                                            <section>
                                                <h5><a href="project-detail.html">Eco Environment Green</a></h5>
                                                <span>Animal Donate</span>
                                                <p>Lorem ipsum dolor sit amet, consectetur adipisci elit. Vestibulu rabitur dignissim luctus nisi id euismod. Don tincidunt diamn tempus donec imperdiet.</p>
                                                <a href="project-detail.html" class="environment-readmore-btn">Read More</a>
                                            </section>
                                    ...
                                    <li class="col-md-12">
                                        <div class="environment-project-list-wrap">
                                            <figure><a href="project-detail.html"><img src="extra-images/project-list-img3.jpg" alt=""><i class=" icon-search4"></i></a></figure>
                                            <section>
                                                <h5><a href="project-detail.html">Working For Childeren Cause</a></h5>
                                                <span>Animal Donate</span>
                                                <p>Lorem ipsum dolor sit amet, consectetur adipisci elit. Vestibulu rabitur dignissim luctus nisi id euismod. Don tincidunt diamn tempus donec imperdiet.</p>
                                                <a href="project-detail.html" class="environment-readmore-btn">Read More</a>
                                            </section>
                                    ...
                                    <li class="col-md-12">
                                        <div class="environment-project-list-wrap">
                                            <figure><a href="project-detail.html"><img src="extra-images/project-list-img4.jpg" alt=""><i class=" icon-search4"></i></a></figure>
                                            <section>
                                                <h5><a href="project-detail.html">Eco Environment Green</a></h5>
                                                <span>Animal Donate</span>
                                                <p>Lorem ipsum dolor sit amet, consectetur adipisci elit. Vestibulu rabitur dignissim luctus nisi id euismod. Don tincidunt diamn tempus donec imperdiet.</p>
                                    ...
                                    <li class="col-md-12">
                                        <div class="environment-project-list-wrap">
                                            <figure><a href="project-detail.html"><img src="extra-images/project-list-img5.jpg" alt=""><i class=" icon-search4"></i></a></figure>
                                            <section>
                                                <h5><a href="project-detail.html">Plant The Tree And Save Nature</a></h5>
                                                <span>Animal Donate</span>
                                                <p>Lorem ipsum dolor sit amet, consectetur adipisci elit. Vestibulu rabitur dignissim luctus nisi id euismod. Don tincidunt diamn tempus donec imperdiet.</p>
                                                <a href="project-detail.html" class="environment-readmore-btn">Read More</a>
                                            </section>
                                    ...
                                    <li class="col-md-12">
                                        <div class="environment-project-list-wrap">
                                            <figure><a href="project-detail.html"><img src="extra-images/project-list-img6.jpg" alt=""><i class=" icon-search4"></i></a></figure>
                                            <section>
                                                <h5><a href="project-detail.html">Eco Environment Green</a></h5>
                                                <span>Animal Donate</span>
                                                <p>Lorem ipsum dolor sit amet, consectetur adipisci elit. Vestibulu rabitur dignissim luctus nisi id euismod. Don tincidunt diamn tempus donec imperdiet.</p>
		...
		<footer id="environment-footer" class="environment-footer-one">
            ...
            <div class="environment-copyright">
                <div class="container">
                    <div class="row">
                        <div class="col-md-12">
                            <a href="index-2.html" class="environment-footer-logo"><img src="images/footer-logo.png" alt=""></a>
                            <p>© 2016, All Right Reserved - by <a href="index-2.html">EyeCix</a></p>
