    ...
    <div class="environment-main-wrapper">
        ...
        <div class="environment-subheader">
            ...
            <div class="container">
                <div class="row">
                    <div class="col-md-12">
                        <h1>Natural Recources Defence Is Our Mission</h1>
                    </div>
                    <div class="col-md-12">
                        <ul class="environment-breadcrumb">
                            <li><a href="index.php">Homepage</a></li>
                            <li> Publications Detail</li>
                        </ul>
                    </div>
                </div>
            </div>
            ...
            <div class="environment-main-section">
                <div class="container">
                    <div class="row">
                        ...
                        <div class="col-md-12">
                            <figure class="environment-project-thumb"><img src="images/program1.jpg" alt=""></figure>
                        </div>
                        <div class="col-md-9">
                            ...
                            <!--// Project Gallery \\-->
                            <div class="environment-section-heading"><h2><span>Program Gallery</span></h2></div>
                            <div class="environment-gallery environment-masonery-gallery environment-project-gallery">
                                <ul class="row">
                                    <li class="col-md-4">
                                        <figure>
                                            <a href="#"><img src="images/program1.jpg" alt=""><i class="icon-signs23"></i></a>
                                            <figcaption>
                            ...
                            <div class="environment-project environment-project-grid">
                                ...
                                <ul class="row">
                                    <li class="col-md-4">
                                        <figure>
                                            <a href="program-detail.php"><img src="extra-images/project-grid-img1.jpg" alt=""><i class="fa fa-share-square-o"></i></a>
                                        </figure>
                                        <section>
                                            <h5><a href="program-detail.php">Tree Planting</a></h5>
                                            <span>Lorem ipsum</span>
                                        </section>
                                    </li>
                                    <li class="col-md-4">
                                        <figure>
                                            <a href="program-detail.php"><img src="extra-images/project-grid-img2.jpg" alt=""><i class="fa fa-share-square-o"></i></a>
                                        </figure>
                                        <section>
                                            <h5><a href="program-detail.php">Tree Planting</a></h5>
                                            <span>Lorem ipsum</span>
                                    ...
                                    <li class="col-md-4">
                                        <figure>
                                            <a href="program-detail.php"><img src="extra-images/project-grid-img3.jpg" alt=""><i class="fa fa-share-square-o"></i></a>
                                        </figure>
                                        <section>
                                            <h5><a href="program-detail.php">Tree Planting</a></h5>
                                            <span>Lorem ipsum</span>
